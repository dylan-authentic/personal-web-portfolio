            ...
            <GlassCardContainer>
                <GlassCardDark>
                    <ContentWrapper>
                        ...
                        <p>
                I'm Dylan 👋🏽<br /><br />
                I'm a product manager at Mediaocean, where I work on adtech solutions for enterprise advertisers. I have a bachelor's degree in computer science and over 6 years of experience in technical and product roles.<br /><br />
                As a product manager, I drive outcomes through customer obsessions, strong attention to detail, understanding first principles, feedback and collaboration, and consistent execution. I work to set clear, measurable goals and follow through to achieve them.<br/><br />
                I started my career interning as a software engineer in undergrad{isExpanded ? ', where I ' : ', where I...'}
                 {isExpanded && (
                    <>
                        built a strong technical foundation. Post-graduation, I worked as a web & database administrator at the New York County Lawyers Association, where I honed my Data Analysis and SQL database skills. After this role, I pursued my first stint of entrepreneurship and self-employment, providing contract services to small and medium businesses. During this time, I gained valuable business experience and developed and launched successful software projects, including full-stack web programs, automation solutions, and service briefs for clients. This work grew my interest for not only working on technical problems, but also identifying business and customer problems that could be solved using software, leading me to pursue my current role in product management full-time.<br /><br />
