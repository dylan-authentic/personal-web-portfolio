            ...
            <GlassCardContainer>
                <GlassCardDark>
                        ...
                        <ContentWrapper>
                            ...
                            {/* </TickerContainer> */}
                            <p>Greetings, I'm Dylan <span style={{fontSize: '22px'}}>👋🏽</span>{<br/>} {<br/>}I'm a product manager at Mediaocean, where I work on adtech solutions for enterprise advertisers. With a degree in computer science and over 6 years of technical roles, my experiences have helped develop a versatile skill set across full-stack software development and product building.{<br/>} {<br/>}As a product manager, I'm committed to driving outcomes through first principles thinking, valuing feedback and collaboration, and employing algorithmic execution. My focus is on establishing clear goals, devising practical plans, and continuously following through to achieve them.{<br/>} {<br/>}I'm passionate about business, entreprenuership, learning, music, and tech. I'm based in New York City.{<br/>} {<br/>} </p>
                            {/* <ControllerContainer>
