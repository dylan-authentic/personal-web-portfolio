      ...
      <div className={styles.section}>
        ...
        <div className={styles.introContent}>
          <p>
            ...
            <br/><br/>I'm an entrepreneur building businesses in my spare time, and I advise small and medium-sized businesses in adopting simple and useful technology for the digital era.‍
